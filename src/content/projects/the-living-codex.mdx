...
<div className="project-media-pair project-media-pair--interface">
  <figure><img src="/living-codex/docs/screenshots/create-character-empty.png" alt="The empty character creation screen" /><figcaption>The empty character creation state.</figcaption></figure>
  <figure><img src="/living-codex/docs/screenshots/create-character-flow.png" alt="Character creation with species and class populated" /><figcaption>Species and class identity appear while the character takes shape.</figcaption></figure>
</div>
...
<div className="interface-gallery">
  <figure><img src="/living-codex/docs/screenshots/edit-mode-core.png" alt="Living Codex Edit Mode core screen" /><figcaption>Identity, species, class and ability-score setup.</figcaption></figure>
  <figure><img src="/living-codex/docs/screenshots/edit-mode-spellcraft.png" alt="Living Codex Edit Mode spellcraft screen" /><figcaption>Spellcasting setup and known or prepared spells.</figcaption></figure>
  <figure><img src="/living-codex/docs/screenshots/edit-mode-combat-mechanics.png" alt="Living Codex combat mechanics editor" /><figcaption>Saves, skills, attacks and derived combat values.</figcaption></figure>
  <figure><img src="/living-codex/docs/screenshots/edit-mode-gear-inventory.png" alt="Living Codex gear and inventory editor" /><figcaption>Inventory, quantities, notes and equipment.</figcaption></figure>
  <figure><img src="/living-codex/docs/screenshots/edit-mode-chronicle.png" alt="Living Codex chronicle editor" /><figcaption>Portrait, background, character notes and currency.</figcaption></figure>
</div>
...
<figure className="interface-payoff"><img src="/living-codex/docs/screenshots/play-mode-tactical-board.png" alt="The Living Codex Play Mode tactical board" /><figcaption>Play Mode keeps the changing, at-table state in reach.</figcaption></figure>
...
<p className="project-link-row"><a href="/living-codex/index.html">Open The Living Codex →</a><a href="https://github.com/Marzogh/The-Living-Codex">Browse the source ↗</a><a href="https://github.com/Marzogh/The-Living-Codex/blob/main/docs/v2-spec.md">Read the v2 specification ↗</a></p>

## Printing a field copy

The project also has a print layout.

I still find a paper character sheet useful in some situations, and I did not want printing to mean squeezing the browser interface onto A4 and hoping for the best. The print view takes the same character state and lays it out as a document intended to be used on paper.

<div className="print-launcher">
  <div><span className="editorial-kicker">Field copy</span><h3>Turn an exported pack into a printable character record</h3><p>The ZIP is read in this browser and passed to the local print layout; it is not uploaded.</p></div>
  <form id="lcx-pdf-form"><label htmlFor="lcx-zip">Character pack</label><input id="lcx-zip" type="file" accept=".zip,application/zip" required /><button type="submit">Prepare field copy →</button><p id="lcx-pdf-status" role="status" aria-live="polite"></p></form>
</div>

It gives me a backup that does not care whether the laptop is charged, connected or behaving itself, and it is much easier to scribble temporary notes on during a session.

<script type="module" src="/scripts/living-codex-print-launcher.mjs"></script>
...
<p className="project-link-row project-link-row--final"><a href="/living-codex/index.html">Open The Living Codex →</a><a href="https://github.com/Marzogh/The-Living-Codex">Browse the source ↗</a><a href="https://github.com/Marzogh/The-Living-Codex/blob/main/docs/v2-spec.md">Read the v2 specification ↗</a></p>
