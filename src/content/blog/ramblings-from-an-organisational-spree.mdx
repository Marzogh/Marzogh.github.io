...
pullQuotes:
  ...
  - "They are moods pretending to be categories."
  - "That earlier version of yourself is the problem. He is always too optimistic."
  - "The system fails under normal use, not exceptional use."
  - "A good kitchen works because the objects live near the movement that needs them."
featured: false
---
